...
if __name__ == "__main__":
   ...
   if not player:
      ...
      player = Player(nome)
      print(f"Olá {player}, esse é um mundo habitado por pokemons, sua missão é se tornar um mestre dos pokemons")
      print(f"Capture o máximo de pokemons que conseguir e lute com seus inimigos")
      ...
      print("Pronto, agora que você já possui um pokemon, enfrete seu arquirival desde a infância, Gary")
