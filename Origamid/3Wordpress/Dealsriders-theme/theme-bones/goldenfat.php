<?php // Template Name: page-goldenfat ?>
    ...
    <main class="titulo-bg">
        <div>
            <div class="titulo container">
                <p class="font-2-xl cor-5">R$ 84.420</p>
                <h1 class="font-1-xxl cor-0">Golden Fat<span class="escuro3">.</span></h1>
            </div>
        </div>
        ...
        <div class="motocicleta container">
            ...
            <div class="motocicleta-conteudo">
                <p class="font-2-l cor-5">A Golden Fat é uma das inspirações para quem deseja velocidade, vigor e estilo em seus dias monótonos.</p>
                <div class="motocicleta-comprar">
                    <a href="<?php echo get_home_url(); ?>/orcamento?tipo=motocicleta&produto=golden" class="btn-claro"> comprar agora</a>
